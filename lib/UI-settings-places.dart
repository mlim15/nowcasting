...
class PlaceSettingsScreen extends StatefulWidget {
  ...
  @override
  PlaceSettingsScreenState createState() =>
      new PlaceSettingsScreenState(rebuildCallback);
}
      ...
      onToggle: (bool value) async {
        ...
        if (location is loc.CurrentLocation && location.coordinates == null) {
          if (!await loc.currentLocation.update(withRequests: true)) {
            _placeSettingsScaffoldKey.currentState
    ...
    return Scaffold(
      ...
      body: SettingsList(
        ...
        sections: [
          ...
          SettingsSection(title: 'Notifications for...', tiles: [
