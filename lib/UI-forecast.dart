  ...
  _addLocationPressed() async {
    setState(() {
      if (loc.currentLocation.coordinates == null ||
          imagery.coordOutOfBounds(loc.currentLocation.coordinates)) {
        loc.savedPlaces.add(loc.SavedLocation(
            name: "New Location", coordinates: LatLng(0, 0), notify: false));
        io.savePlaceData();
      } else {
        loc.savedPlaces.add(loc.SavedLocation(
            name: "Copy of Current Location",
            coordinates: new LatLng(loc.currentLocation.coordinates.latitude,
                loc.currentLocation.coordinates.longitude),
            notify: false));
        io.savePlaceData();
      }
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[
            loc.savedPlaces.isNotEmpty
                ? IconButton(
                    icon: _editing ? Icon(Icons.done) : Icon(Icons.edit),
                    onPressed: () {
                      _editPressed();
                    },
                  )
        ...
        body: RefreshIndicator(
          color: ux.darkMode(context) ? Colors.white : ux.nowcastingColor,
          onRefresh: () async {
            ...
            slivers: <Widget>[
                  ...
                  ? SliverPadding(
                      ...
                      sliver: SliverFixedExtentList(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) => new ux.WarningSliver(
                              ux.radarOutageText, ux.WarningLevel.notice,
                              url: ux.radarOutageUrl),
              ...
              loc.weatherAlert
                  ? SliverPadding(
                      ...
                      sliver: SliverFixedExtentList(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) => new ux.WarningSliver(
                              ux.alertText, ux.WarningLevel.alert,
                              url: ux.alertUrl),
                          childCount:
                              1, //TODO loc.alerts.length? store in array for multiple location alerts?
                        ),
                      ),
                    )
                  : SliverToBoxAdapter(
              ...
              loc.currentLocation.coordinates != null
                  ...
                  ? SliverPadding(
                      padding: const EdgeInsets.symmetric(vertical: 0.0),
                      sliver: SliverFixedExtentList(
                        delegate: imagery.coordOutOfBounds(
                            ...
                            ? SliverChildBuilderDelegate(
                                (context, index) => new ForecastSliver(
                                    loc.currentLocation, _editing, () {
                                  _rebuild();
                                }),
                                childCount: 1,
                              )
                            ...
                            : SliverChildBuilderDelegate(
                                (context, index) => new ux.WarningSliver(
                                    "McGill's nowcasting service does not provide data for your current location.",
                                    ux.WarningLevel.notice),
                                childCount: 1,
                              ),
                        itemExtent: imagery.coordOutOfBounds(
                                    loc.currentLocation.coordinates) ==
                                false
                            ? _editing
              ...
              (loc.savedPlaces.isNotEmpty)
                  ? SliverPadding(
                      ...
                      sliver: SliverFixedExtentList(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, index) => new ForecastSliver(
                              loc.savedPlaces[index], _editing, () {
                            _rebuild();
                          }),
                  ...
                  : loc.savedPlaces.isEmpty
                      ...
                      : SliverPadding(
                          ...
                          sliver: SliverFixedExtentList(
                            ...
                            delegate: SliverChildBuilderDelegate(
                              (context, index) => new ux.WarningSliver(
                                  "There was an error loading your stored locations.",
                                  ux.WarningLevel.alert),
                              childCount: 1,
                            ),
                          ),
                        ),
