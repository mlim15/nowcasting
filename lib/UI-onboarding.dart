...
class OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void _onIntroEnd(context) async {
    if (_cachedSuccessfully) {
      ...
      print(
          'onboarding.OnboardingScreenState: User tried to continue without downloading images, prevented');
    }
  }
  ...
  Widget build(BuildContext context) {
    bool _showLocationsPage = Platform.isIOS ||
        (Platform.isAndroid && main.androidInfo.version.sdkInt >= 23);
        ...
        body: IntroductionScreen(
          ...
          pages: [
            PageViewModel(
              ...
              decoration: ux.darkMode(context)
                  ? ux.pageDecorationDark
                  : ux.pageDecorationLight,
            ),
            PageViewModel(
              title: "Initial Download",
              body:
                  "To get started, we need to download ~1MB of initial weather data.",
              ...
              footer: new ProgressButton(
                defaultWidget:
                    Text('Download Now', style: ux.progressButtonTextStyle),
                ...
                onPressed: () async {
                  ...
                  try {
                    ...
                    update.CompletionStatus _result =
                        await update.completeUpdate(true, true);
                    if (_result == update.CompletionStatus.success ||
                        _result == update.CompletionStatus.unnecessary) {
                      doNotProceed = false;
                    }
                  } catch (e) {
                    print(
                        'onboarding.OnboardingScreenState: Could not get initial images' +
                            e.toString());
                    _obScaffoldKey.currentState
                        .showSnackBar(ux.onboardErrorSnack);
                  }
                  return () {
            ...
            if (_showLocationsPage)
              PageViewModel(
                ...
                body:
                    "Giving access to your location will enable the app to provide local forecasts. Giving access to your location in the background will enable more accurate notifications.",
                image: _buildImage('manypixels-iso-navigation'),
                decoration: ux.darkMode(context)
                    ? ux.pageDecorationDark
                    : ux.pageDecorationLight,
                footer: new ProgressButton(
                  defaultWidget: Text('Request Permission',
                      style: ux.progressButtonTextStyle),
                  progressWidget: ux.progressButtonWidget,
                  width: ux.progressButtonWidth,
                  height: ux.progressButtonHeight,
                  borderRadius: ux.progressButtonBorderRadius,
            ...
            PageViewModel(
                title: "Notifications",
                body:
                    "Would you like the app to check roughly once an hour in the background for incoming rain at your location? You won't be notified more than once per three hours at the very most.",
                image: _buildImage('manypixels-iso-fishing'),
                decoration: ux.darkMode(context)
                    ? ux.pageDecorationDark
                    : ux.pageDecorationLight,
                footer: new ProgressButton(
                  defaultWidget: Text("Enable Notifications",
                      style: ux.progressButtonTextStyle),
                  progressWidget: ux.progressButtonWidget,
                  width: ux.progressButtonWidth,
                  height: ux.progressButtonHeight,
                  ...
                  onPressed: () async {
                    ...
                    if (loc.currentLocation.coordinates != null) {
                      ...
                      if (Platform.isIOS) {
                        ...
                        _notifPermGranted = await notifications
                      ...
                      if (_notifPermGranted) {
                        ...
                        _obScaffoldKey.currentState
                            .showSnackBar(ux.notificationPermissionErrorSnack);
                      }
                    } else {
                      // User did not grant location perms
                      _obScaffoldKey.currentState
                          .showSnackBar(ux.notificationLocPermissionErrorSnack);
                    }
                    return () {
